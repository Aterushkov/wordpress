            ...
            <div class="reply__body">
                <div class="reply__title">
                    Оставьте ваш вопрос здесь
                        ...
                        <?= do_shortcode('[contact-form-7 id="123" title="Форма заявки"]');?>
            </div>
        </div>
        <footer>
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?the_field('insta', 2)?>" class="footer__social-item">
                            ...
                            <a href="<?the_field('feice', 2)?>" class="footer__social-item">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="<?the_field('phone1', 2)?>"><?the_field('phone1', 2)?></a>
                                    <a href="<?the_field('phone2', 2)?>"><?the_field('phone2', 2)?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAeEOsYwkvSyIenDKGkOBuJgFLIv1L_sGM"></script> 
