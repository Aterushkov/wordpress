...
?>
        ...
        <div class="mainslider glide">
            ...
            foreach( $posts as $post ){
                setup_postdata($post);
                ?>
                    <li style="background-image: url('<? the_field('slide_img');?>')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                                    ...
                                    <?
                                    $field = get_field('button_in_slider');
                                    if($field == 'yes'){
                                        ?>
                                        <a href="<?the_field('link_in_res')?>" class="button">Узнать больше</a>
                                        <?
                                    } 
                                        ?>
